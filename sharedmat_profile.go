...
//
//	Terminal
//	  Tab1 Run `go run -tags profile github.com/jonoton/go-sharedmat`
...
func init() {
	profName := "github.com/jonoton/go-sharedmat/sharedmat.counts"
...
func getStackNameStr(frame runtime.Frame) string {
	...
	name = strings.ReplaceAll(name, "github.com/jonoton/go-sharedmat/", "")
	return name
}
